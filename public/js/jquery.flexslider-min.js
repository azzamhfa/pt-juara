                ...
                update: function (e) {
                    e === "play"
                        ? r.pausePlay
                              .removeClass(i + "pause")
                              .addClass(i + "play")
                              .text(r.vars.playText)
                        : r.pausePlay
                              .removeClass(i + "play")
                              .addClass(i + "pause")
                              .text(r.vars.pauseText);
                },
            },
            touch: function () {
                function p(o) {
                        ...
                        i =
                            c && l && r.animatingTo === r.last
                                ...
                                ? (r.itemW + r.vars.itemMargin) *
                                  ...
                                  r.currentSlide
                                : l
                                ? (r.last - r.currentSlide + r.cloneOffset) * s
                ...
                function d(t) {
                    ...
                    a = f
                        ? Math.abs(o) < Math.abs(t.touches[0].pageX - n)
                        : Math.abs(o) < Math.abs(t.touches[0].pageY - n);
                    if (!a || Number(new Date()) - u > 500) {
                        ...
                        if (!h && r.transitions) {
                            if (!r.vars.animationLoop) {
                                o =
                                    o /
                                    ((r.currentSlide === 0 && o < 0) ||
                                    (r.currentSlide === r.last && o > 0)
                                        ? Math.abs(o) / s + 2
                                        : 1);
                            }
