...
<body>
	...
	<div class="container-fluid intro w-75" id="about">
		<div class="d-flex">
	...
	<div class="container-fluid">
		<div class="row">
			<div class="d-flex flex-column col-md-8 nopadding align-items-center justify-content-center wp1" id="work">
				<h1 class="text-center">Our Business</h1>
				<div class="d-flex justify-content-center flex-wrap w-75">
					<div class="card p-3 m-3" style="width: 12rem;" id="poultry">
						<img src="/img/kaf.png" class="card-img-top" alt="...">
						<div class="card-body">
							<h4 class="card-title text-center">Poultry Shop</h1>
						</div>
					</div>
					<div class="card p-3 m-3" style="width: 12rem;" id="trading">
						<img src="/img/kaf.png" class="card-img-top" alt="...">
						<h4 class="card-title text-center">TRADING BAHAN BAKU PAKAN & HOME MIXER</h1>
					</div>
					<div class="card p-3 m-3" style="width: 12rem;">
						<img src="/img/kaf.png" class="card-img-top" alt="...">
